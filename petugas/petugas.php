...
<html lang="en">
    <head>
        ...
        <title>Pembayaran SPP - Login Petugas</title>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="petugas.php?url=history-pembayaran">
    ...
    <script>
  // Mendapatkan URL dari halaman saat ini
  var currentUrl = window.location.href;

  // Mencari link pada menu samping yang sesuai dengan URL halaman saat ini
